...
class WordGenerator {
  ...
  static let possibleWords = ["APPLE", "GRAPE", "BANJO", "BRAVE", "CHAIR",
                              "CLOUD", "DREAM", "FLUTE", "GHOST", "HAPPY",
                              "JUMPY", "KNEEL", "LIGHT", "MAGIC", "NIGHT",
                              "OCEAN", "PLANT", "QUICK", "ROUND", "SMILE",
                              "TABLE", "UNDER", "VIVID", "WATER", "XYLOX",
                              "YEAST", "ZEBRA"]
